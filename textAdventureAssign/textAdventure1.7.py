...
goList = ["go back", "go", "leave", "go away", "nothing", "none", "nevermind"]
...
def adventure():
    ...
    while dungeon:
        ...
        if roomNum <= 0:
            ...
            time.sleep(2)
            inpt = input("Proceed to the next room, leave the dungeon, check status, or use an item?\n").lower()
            time.sleep(1)
        ...
        if inpt in ["forest town", "forest", "town"]:
            ...
            while temple:
                ...
                if inpt in ["market", "gift market", "shop", "store"]:
                    ...
                    time.sleep(2)
                    print("The Monks are willing to train you, for a small price. It's pricey, but you will level up.")
                    time.sleep(2)
