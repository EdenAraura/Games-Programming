...
def useItem():
    ...
    while use:
        ...
        if inpt in inv:
            ...
            if inpt in ["sword", "shortsword", "short sword", "short-sword"]:
        ...
        if inpt in yesList:
            if coin >= 30:
                ...
                if restEvent == "break in":
                    ...
                    print("As you enter your temporary lodging, you notice it's previous occupier left some loose change. Finders Keepers!")
                    coin += 5 + (round(lvl / 3))
                    print("Your health has been restored to " + str(tempHealth))
        ...
        if inpt in ["forest town", "forest", "town"]:
            ...
            while temple:
                ...
                if inpt in ["market", "gift market", "shop", "store"]:
                    ...
                    inpt = input("Do you wish to train for 150 coin?").lower()
                    if inpt in yesList:
                        if coin >= 150:
                            coin -= 150
                            levelUp()
